...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="en-US">
    <head>
        ...
        <link type="text/css" href="style/backoffice_login - copia - copia.css"  rel="stylesheet"/>
        ...
        <div id="login">
            ...
            <h1>
                ...
                <a href="" title="<?php echo View::newInstance()->_get('login_admin_title'); ?>">
            ...
            <form name="loginform" id="loginform" action="<?php echo osc_admin_base_url(true); ?>" method="post">
                ...
                <p class="submit">
                    <input type="submit" name="submit" id="submit" value="<?php echo osc_esc_html( __('Iniciar Sesion')); ?>"/>
                </p>
        ...
        <p id="backtoblog"><a href="<?php echo osc_base_url(); ?>" title="<?php echo osc_esc_html( sprintf( __('Ir a %s'), osc_page_title() )); ?>">&larr; <?php printf( __('Ir a %s'), osc_page_title() ); ?></a></p>
