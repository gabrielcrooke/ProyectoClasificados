...
<div class="grid-system" id="stats-page">
    <div class="grid-row grid-50 no-bottom-margin">
        <div class="row-wrapper">
            <h2 class="render-title"><?php _e('Estadisticas de los anuncios'); ?></h2>
        </div>
    </div>
        ...
        <div class="row-wrapper">
            <div class="widget-box">
                <div class="widget-box-title">
                    <h3><?php _e('Nuevos anuncios'); ?></h3>
                </div>
                <div class="widget-box-content">
                    <b class="stats-title"><?php _e('Numero de nuevos anuncios'); ?></b>
    ...
    <div class="grid-row grid-50">
        <div class="row-wrapper">
            <div class="widget-box">
                <div class="widget-box-title">
                    <h3><?php _e('Anuncios \ vistas'); ?></h3>
                </div>
                <div class="widget-box-content">
                    <b class="stats-title"><?php _e("Número total de vistas de anuncios"); ?></b>
                    <div id="placeholder_total" class="graph-placeholder" style="height:150px">
                        <?php if( count($reports) == 0 ) {
                            _e("Todavía no hay estadísticas");
                        } ?>
                    </div>
                </div>
            </div>
