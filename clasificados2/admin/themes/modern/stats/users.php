...
<div class="grid-system" id="stats-page">
    <div class="grid-row grid-50 no-bottom-margin">
        <div class="row-wrapper">
            <h2 class="render-title"><?php _e('Usuarios estadisticas'); ?></h2>
        </div>
    </div>
    <div class="grid-row grid-50 no-bottom-margin">
        <div class="row-wrapper">
            <a id="monthly" class="btn float-right <?php if($type=='month') echo 'btn-green';?>" href="<?php echo osc_admin_base_url(true); ?>?page=stats&amp;action=users&amp;type_stat=month"><?php _e('Ultimos 10 meses'); ?></a>
            <a id="weekly"  class="btn float-right <?php if($type=='week') echo 'btn-green';?>" href="<?php echo osc_admin_base_url(true); ?>?page=stats&amp;action=users&amp;type_stat=week"><?php _e('Ultimas 10 semanas'); ?></a>
            <a id="daily"   class="btn float-right <?php if($type==''||$type=='day') echo 'btn-green';?>" href="<?php echo osc_admin_base_url(true); ?>?page=stats&amp;action=users&amp;type_stat=day"><?php _e('Ultimos 10 dias'); ?></a>
        </div>
    </div>
    ...
    <div class="grid-row grid-50">
        <div class="row-wrapper">
            <div class="widget-box">
                <div class="widget-box-title">
                    <h3><?php _e('Usuarios por ciudad'); ?></h3>
                </div>
                <div class="widget-box-content">
                    <b class="stats-title"></b>
    ...
    <div class="grid-row grid-50">
        <div class="row-wrapper">
            <div class="widget-box">
                <div class="widget-box-title">
                    <h3><?php _e('Usuarios por region'); ?></h3>
                </div>
                <div class="widget-box-content">
                    <b class="stats-title"></b>
    ...
    <div class="grid-row grid-50">
        <div class="row-wrapper">
            <div class="widget-box">
                <div class="widget-box-title"><h3><?php _e('Ultimos usuarios'); ?></h3></div>
                <div class="widget-box-content">
                    ...
                    <?php } else { ?>
                        <p><?php _e("No estadisticas todavia"); ?></p>
                    <?php } ?>
    ...
    <div class="grid-row grid-50">
        <div class="row-wrapper">
            <div class="widget-box">
                <div class="widget-box-title"><h3><?php _e('Avg. articulos por ususarios'); ?></h3></div>
                <div class="widget-box-content">
                    <div class="stats-detail">
                        <?php printf( __('%s anuncios por usuarios'), number_format($item, 2) ); ?>
                    </div>
                </div>
            </div>
        </div>
