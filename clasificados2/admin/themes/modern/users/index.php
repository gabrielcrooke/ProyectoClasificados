...
<?php
    ...
    function customPageTitle($string) {
        return sprintf(__('Gestionar usuarios &raquo; %s'), $string);
    }
...
<h2 class="render-title"><?php _e('Gestionar usuarios'); ?> <a href="<?php echo osc_admin_base_url(true) . '?page=users&action=create'; ?>" class="btn btn-mini"><?php _e('Agregar nuevo'); ?></a></h2>
<div class="relative">
        ...
        <div class="float-right">
            <form method="get" action="<?php echo osc_admin_base_url(true); ?>"  class="inline nocsrf">
                ...
                <select name="iDisplayLength" class="select-box-extra select-box-medium float-left" onchange="this.form.submit();" >
                    ...
                    <option value="25" <?php if( Params::getParam('iDisplayLength') == 25 ) echo 'selected'; ?> ><?php printf(__('%d Usuarios'), 25); ?></option>
                    <option value="50" <?php if( Params::getParam('iDisplayLength') == 50 ) echo 'selected'; ?> ><?php printf(__('%d Usuarios'), 50); ?></option>
                    <option value="100" <?php if( Params::getParam('iDisplayLength') == 100 ) echo 'selected'; ?> ><?php printf(__('%d Usuarios'), 100); ?></option>
                </select>
            </form>
...
<form id="dialog-user-delete" method="get" action="<?php echo osc_admin_base_url(true); ?>" class="has-form-actions hide" title="<?php echo osc_esc_html(__('Delete user')); ?>">
    ...
    <div class="form-horizontal">
        <div class="form-row">
            <?php _e('¿Estás seguro de que quieres eliminar este usuario?'); ?>
        </div>
        <div class="form-actions">
            <div class="wrapper">
            <a class="btn" href="javascript:void(0);" onclick="$('#dialog-user-delete').dialog('close');"><?php _e('Cancelar'); ?></a>
            <input id="user-delete-submit" type="submit" value="<?php echo osc_esc_html( __('Borrar') ); ?>" class="btn btn-red" />
            </div>
        </div>
    </div>
</form>
