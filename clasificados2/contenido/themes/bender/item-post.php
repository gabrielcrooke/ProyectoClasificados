...
<?php osc_current_web_theme_path('header.php') ; ?>
    ...
    <div class="form-container form-horizontal">
        <div class="resp-wrapper">
            <div class="header">
                <h1><?php _e('Publicar un anuncio', 'bender'); ?></h1>
            </div>
            <ul id="error_list"></ul>
                <form name="item" action="<?php echo osc_base_url(true);?>" method="post" enctype="multipart/form-data" id="item-post">
                    ...
                    <?php } ?>
                        <h2><?php _e('Informacion general', 'bender'); ?></h2>
                        <div class="control-group">
                            <label class="control-label" for="select_1"><?php _e('Categoria', 'bender'); ?></label>
                            <div class="controls">
                                <?php ItemForm::category_select(null, null, __('Seleccione una categoria', 'bender')); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="title[<?php echo osc_current_user_locale(); ?>]"><?php _e('Titulo', 'bender'); ?></label>
                            <div class="controls">
                                <?php ItemForm::title_input('title',osc_current_user_locale(), osc_esc_html( bender_item_title() )); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="description[<?php echo osc_current_user_locale(); ?>]"><?php _e('Descripción', 'bender'); ?></label>
                            <div class="controls">
                        ...
                        <div class="control-group control-group-price">
                            <label class="control-label" for="price"><?php _e('Precio', 'bender'); ?></label>
                            <div class="controls">
                        ...
                        <div class="box location">
                            <h2><?php _e('Ubicacion', 'bender'); ?></h2>
                            <?php if(count(osc_get_countries()) > 1) { ?>
                            <div class="control-group">
                                <label class="control-label" for="country"><?php _e('País', 'bender'); ?></label>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <label class="control-label" for="cityArea"><?php _e('Área urbana', 'bender'); ?></label>
                                <div class="controls">
                                    <?php ItemForm::city_area_text(osc_user()); ?>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="address"><?php _e('Dirección', 'bender'); ?></label>
                                <div class="controls">
                        ...
                        <div class="box seller_info">
                            <h2><?php _e("Informacion del vendedor", 'bender'); ?></h2>
                            <div class="control-group">
                                <label class="control-label" for="contactName"><?php _e('Nombre', 'bender'); ?></label>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <div class="controls checkbox">
                                    <?php ItemForm::show_email_checkbox(); ?> <label for="showEmail"><?php _e('Mostrar correo electrónico en la página', 'bender'); ?></label>
                                </div>
                            </div>
                        </div>
                        <?php
                        ...
                        <div class="control-group">
                            ...
                            <?php }?>
                            <div class="controls">
                                <button type="submit" class="ui-button ui-button-middle ui-button-main"><?php if($edit) { _e("Update", 'bender'); } else { _e("Publicar", 'bender'); } ?></button>
                            </div>
                        </div>
                    </fieldset>
                </form>
