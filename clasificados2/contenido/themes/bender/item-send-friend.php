...
<div class="form-container form-horizontal form-container-box">
    <div class="header">
        <h1><?php _e('Enviar a un amigo', 'bender'); ?></h1>
    </div>
    <div class="resp-wrapper">
        ...
        <form name="sendfriend" action="<?php echo osc_base_url(true); ?>" method="post" >
            ...
            <?php } ?>
            <div class="control-group">
                <label class="control-label" for="friendName"><?php _e("Nombre de tu amigo",'bender'); ?></label>
                <div class="controls">
                    <?php SendFriendForm::friend_name(); ?>
                </div>
            </div>
            <div class="control-group">
                <label for="friendEmail"><?php _e("E-mail de tu amigo", 'bender'); ?></label> </label>
                <div class="controls">
