...
<h1><strong><?php _e('Últimos anuncios', 'bender') ; ?></strong></h1>
 <?php if( osc_count_latest_items() == 0) { ?>
    <div class="clear"></div>
    <p class="empty"><?php _e("No hay anuncios disponibles en este momento", 'bender'); ?></p>
<?php } else { ?>
    <div class="actions">
    ...
    <?php if( osc_count_latest_items() == osc_max_latest_items() ) { ?>
        <p class="see_more_link"><a href="<?php echo osc_search_show_all_url() ; ?>">
            <strong><?php _e('Ver todos los anuncios', 'bender') ; ?> &raquo;</strong></a>
        </p>
    <?php } ?>
<?php } ?>
</div>
...
<div id="sidebar">
    ...
    <div class="widget-box">
        ...
        <div class="box location">
            <h3><strong><?php _e("Ubicacion", 'bender') ; ?></strong></h3>
            <ul>
