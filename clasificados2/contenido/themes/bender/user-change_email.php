<?php
    ...
    function custom_meta_title($data){
        return __('Cambiar e-mail', 'bender');;
    }
    osc_current_web_theme_path('header.php') ;
    $osc_user = osc_user();
?>
<h1><?php _e('Cambiar e-mail', 'bender'); ?></h1>
    ...
    <div class="resp-wrapper">
        ...
        <form id="change-email" action="<?php echo osc_base_url(true); ?>" method="post">
            ...
            <div class="control-group">
                <label for="email"><?php _e('Corriente e-mail', 'bender'); ?></label>
                <div class="controls">
                    <?php echo osc_logged_user_email(); ?>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="new_email"><?php _e('Nuevo e-mail', 'bender'); ?> *</label>
                <div class="controls">
